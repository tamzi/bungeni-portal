...
//require_once($mvgIP . '/languages/MV_LanguageEn.php');
...
/**********************************************/
	...
	*/		
	function mvfAddHTMLHeader($head_set='') {
		...
		global $mvgScriptPath, $wgJsMimeType, $wgOut , $mvEnableAutoComplete, $mvEnableJSLinkBack, $mvEnableJSMVDrewrite, $wgScriptPath;		
...
function mvInitNamespaces() {
	...
	//$wgExtraNamespaces[MV_NS_SITTING] = "Sitting";
	//$wgExtraNamespaces[MV_NS_SITTING_TALK] = "Sitting_talk";
	...
	$mvLastNamespaceIndex =  $mvNamespaceIndex +8;
}
