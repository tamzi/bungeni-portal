...
class OrderOfBusiness(BaseFolder):
    """
    """
    ...
    archetype_name = 'OrderOfBusiness'

    meta_type = 'OrderOfBusiness'
    portal_type = 'OrderOfBusiness'
    allowed_content_types = ['AgendaItem']
    filter_content_types = 1
    global_allow = 0
    #content_icon = 'OrderOfBusiness.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "OrderOfBusiness"
    typeDescMsgId = 'description_edit_orderofbusiness'
