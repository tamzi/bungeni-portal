...
from Products.BungeniSkinNG.config import PROJECTNAME
from Products.BungeniSkinNG.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinNG """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinNG.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinNG.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinNG.config import JAVASCRIPTS
    try:
