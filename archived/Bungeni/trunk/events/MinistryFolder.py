...
class MinistryFolder(BaseFolder):
    """
    """
    ...
    archetype_name = 'MinistryFolder'

    meta_type = 'MinistryFolder'
    portal_type = 'MinistryFolder'
    allowed_content_types = ['MinistryWS']
    filter_content_types = 1
    global_allow = 0
    #content_icon = 'MinistryFolder.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "MinistryFolder"
    typeDescMsgId = 'description_edit_ministryfolder'
