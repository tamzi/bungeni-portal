...
from Products.AuditTrail.config import PROJECTNAME
from Products.AuditTrail.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install AuditTrail """
    out = StringIO()
    ...
    try:
        from Products.AuditTrail.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    # uncatalog tools
    for toolname in ['portal_auditortool']:
        try:
    ...
    from Products.AuditTrail.config import STYLESHEETS
    try:
        ...
        pass
    from Products.AuditTrail.config import JAVASCRIPTS
    try:
