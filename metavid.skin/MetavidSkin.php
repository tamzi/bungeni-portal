 ...
 * @addtogroup Skins
 */
class SkinMetavidSkin extends SkinTemplate {
	/** Using monobook version. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'metavidskin';
		$this->stylename = 'metavidskin';
		$this->template  = 'MetavidTemplate';
        /* the following adds messages for Metavid skin */
        global $wgMessageCache;
        $messages['en'] = array(
            'userlogin' => 'Admin Login',
            'disclaimerpage' => 'Project:Powered by MediaWiki',
            'disclaimers' => 'Powered by MediaWiki',
        );
 ...
 * @addtogroup Skins
 */
class MetavidTemplate extends QuickTemplate {
	/**
	 * Template filter callback for Metavid skin.
...
<?php if($this->data['body_onload'    ]) { ?>onload="<?php     $this->text('body_onload')     ?>"<?php } ?>
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
    ...
    <div class="banner" id="p-logoname">
        <p><?php if($wgLogoName){echo $wgLogoName;} ?></p>
    </div>
	<div id="content">
		<a name="top" id="top"></a>
...
<?php 			foreach($this->data['personal_urls'] as $key => $item) {
                if((Sanitizer::escapeId($key) == "anonlogin")||(Sanitizer::escapeId($key) == "login")||(Sanitizer::escapeId($key) == "logout")){ ?>
				<a href="<?php
				echo htmlspecialchars($item['href']) ?>"<?php echo $skin->tooltipAndAccesskey('pt-'.$key) ?><?php
				if(!empty($item['class'])) { ?> class="<?php
				echo htmlspecialchars($item['class']) ?>"<?php } ?>>
<?php
	if ((Sanitizer::escapeId($key) == "anonlogin")||(Sanitizer::escapeId($key) == "login"))
...
<!--UNDESA-->
<div id="menu">
<a href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>">Home</a>
<?php  
...
if( $wgUser->isAllowed('administration') ){
	$rlink=$skin->makeLinkObj( Title::makeTitle(NS_MAIN, 'Administration' ), 'Administration'); echo $rlink;
}
?>
<a href="help">Help</a>
...
<?php } } }
		...
		wfRunHooks( 'MetavidTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
...
<?php
		$footerlinks = array(
			'viewcount', 'credits', 'copyright',
			'about', 'disclaimer', 'tagline', 'poweredby'
		);
