...
class UserDescriptor(ModelDescriptor):
    ...
    fields = [
        ...
        F(name="home_language", 
            label="Home Language", 
            required=False,
            localizable=[ show("view edit add") ],
            value_type="language",
            render_type="single_select",
            vocabulary="language",
        )
...
class DocDescriptor(ModelDescriptor):
    ...
    fields = [
        ...
        F(name="source_publisher_address",
        ...
        F(name="source_language", 
            label="Souce Document Language", 
            required=False,
            localizable=[ show("view edit add") ],
            value_type="language",
            render_type="single_select",
        ...
        F(name="source_coverage",
            label="Source Document Coverage",
            required=False,
            localizable=[
                show("add view edit"),
            ],
