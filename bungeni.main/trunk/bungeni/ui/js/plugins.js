(function ($) {
    ...
    $.fn.bungeniInteractiveSchedule = function () {
        $.each($(this), function (i, o) {
            ...
            function handleSave() {
                editor.saveHTML();
                var d = document.getElementById('discussion-full-text-' + editor.element_id);
            ...
            var onSuccess = function (o) {
                    ...
                    d = document.getElementById("truncated-discussion-" + editor.element_id);
    ...
    $.fn.bungeniCalendarInteractivity = function (ajax_navigation) {
        ...
        var selector = '#' + calendar.attr('id');
        if (ajax_navigation) {
            calendar.find("thead a.navigation").click(function () {
                $("#kss-spinner").show();
