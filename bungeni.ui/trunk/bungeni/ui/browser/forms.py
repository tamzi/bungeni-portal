...
class CustomAddform( ContentAddForm ):
    ...
    def finishConstruction( self, ob ):
        ...
        """
        self.adapters = self.CustomAdaptors
...
substitutionsEditVocab = vocabulary.SQLQuerySource(sql_editSubstitution, 'user_name', 'user_id', {'user_id':'$user_id', 'group_id' : '$group_id'} )  
