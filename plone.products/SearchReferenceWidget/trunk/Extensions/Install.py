...
from Products.SearchReferenceWidget.config import PROJECTNAME
from Products.SearchReferenceWidget.config import product_globals as GLOBALS

def install(self):
    """ External Method to install SearchReferenceWidget """
    out = StringIO()
    ...
    try:
        from Products.SearchReferenceWidget.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.SearchReferenceWidget.config import STYLESHEETS
    try:
        ...
        pass
    from Products.SearchReferenceWidget.config import JAVASCRIPTS
    try:
