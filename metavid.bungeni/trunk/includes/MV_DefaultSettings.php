...
$mvExternalImgServerPath = 'http://localhost/mvWiki/index.php';
...
//<<<<<<< .mine
$mvVideoArchivePaths['mvprime']= 'http://localhost/metavid/';
$mvVideoArchivePaths['cap1'] = 'http://localhost/metavid/';
//=======
...
$editorsTable = 'mv_editors';
$readersTable = 'mv_readers';
$reportersTable='mv_reporters';
$readersAssignmentTable = 'mv_readers_assignments';
$reportersAssignmentTable = 'mv_reporters_assignments';
...
$mvSittingTypePermission['metavid_file']= array('sysop', 'bot');
...
$wgGroupPermissions['user']['mv_edit_sitting']=true;
$wgGroupPermissions['sysop']['mv_edit_sitting']=true;
$wgGroupPermissions['bot']['mv_edit_sitting']=true;
