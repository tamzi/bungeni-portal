...
from config import MEMBER_SPACE_CONTENT, GROUP_SPACE_CONTENT
from config import PUBLIC_FOLDER_ENTRY_NAME, PRIVATE_FOLDER_ENTRY_NAME
...
def create_content(parent, content, owner, content_status):
    #Create custom content in the web spaces.
