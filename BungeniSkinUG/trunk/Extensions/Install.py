...
from Products.BungeniSkinUG.config import PROJECTNAME
from Products.BungeniSkinUG.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinUG """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinUG.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinUG.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinUG.config import JAVASCRIPTS
    try:
