...
LOG('SearchReferenceWidget',INFO, 'Installing Product')
...
DirectoryView.registerDirectory('skins/SearchReferenceWidget',
                                    product_globals)
...
def initialize(context):
    ...
    if CustomizationPolicy and hasattr(CustomizationPolicy, 'register'):
        ...
        print 'Customization policy for SearchReferenceWidget installed'
