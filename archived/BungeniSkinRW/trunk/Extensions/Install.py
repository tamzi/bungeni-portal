...
from Products.BungeniSkinRW.config import PROJECTNAME
from Products.BungeniSkinRW.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinRW """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinRW.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinRW.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinRW.config import JAVASCRIPTS
    try:
