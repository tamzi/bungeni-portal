...
from Products.BungeniSkinPanafrica.config import PROJECTNAME
from Products.BungeniSkinPanafrica.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinPanafrica """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinPanafrica.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinPanafrica.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinPanafrica.config import JAVASCRIPTS
    try:
