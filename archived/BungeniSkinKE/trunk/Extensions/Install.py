...
from Products.BungeniSkinKE.config import PROJECTNAME
from Products.BungeniSkinKE.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinKE """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinKE.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinKE.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinKE.config import JAVASCRIPTS
    try:
