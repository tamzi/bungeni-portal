...
from Products.BungeniDefaultContent.config import PROJECTNAME
from Products.BungeniDefaultContent.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniDefaultContent """
    out = StringIO()
    ...
    try:
        from Products.BungeniDefaultContent.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniDefaultContent.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniDefaultContent.config import JAVASCRIPTS
    try:
