...
$mvVideoArchivePaths['mvprime'] = 'http://localhost/media/';
$mvVideoArchivePaths['cap1'] = 'http://localhost/media/';
 ...
 */
$mvMVDTypeAllAvailable = array( 'ht_en', 'anno_en', 'take_en' );
...
*/
$mvMVDTypeDefaultDisp = array( 'ht_en', 'anno_en', 'take_en' );
