...
abstract class MV_Language {
	...
	protected $m_NamespaceAliases = array(
		...
		'Sitting' 		=> MV_NS_SITTING,
	    	'Sitting_talk'		=> MV_NS_SITTING_TALK,
	    	'Member_of_Parliament'	=> MV_NS_MEMBER_OF_PARLIAMENT,
	    	'Member_of_Parliament_talk' => MV_NS_MEMBER_OF_PARLIAMENT_TALK,
	    	'Bills'			=> MV_NS_BILLS,
	    	'Bills_talk'		=> MV_NS_BILLS_TALK,
	);
