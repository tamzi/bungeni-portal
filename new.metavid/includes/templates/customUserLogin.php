...
<form name="userlogin2" id="userlogin2" method="post" action="<?php $this->text('action') ?>">
	...
	<?php } ?>
		...
		<tr>
			<td class="mw-label"><label for='mvRole'>Role</label></td>
					<td class="mw-input">
						<select name="mv_role">
						<?php
	$options=array("sysop"=>"Administator", "chief_editor"=>"Chief Editor", "editor"=>"Editor","reader"=>"Reader","reporter"=>"Reporter");
							foreach ($options as $value => $name) {?>
							<option value="<?php echo $value ?>" <?php if ($this->data['mv_role'] == $value) echo "selected" ?> > <?php echo $name ?></option>
							<?php } ?>
						</select>
			</td>
