...
checkMemberTitleDuplicates = """
                        ...
                        AND ( ( "role_titles"."title_name_id" =  :title_name_id  AND "role_titles"."membership_id" =  :membership_id  ) )
                        AND ((:date  BETWEEN "role_titles"."start_date" AND "role_titles"."end_date")
                             OR ((:date  >= "role_titles"."start_date" AND "role_titles"."end_date" IS NULL)))
                        """
