...
from Products.BungeniSkinMZ.config import PROJECTNAME
from Products.BungeniSkinMZ.config import product_globals as GLOBALS

def install(self, reinstall=False):
    """ External Method to install BungeniSkinMZ """
    out = StringIO()
    ...
    try:
        from Products.BungeniSkinMZ.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.BungeniSkinMZ.config import STYLESHEETS
    try:
        ...
        pass
    from Products.BungeniSkinMZ.config import JAVASCRIPTS
    try:
