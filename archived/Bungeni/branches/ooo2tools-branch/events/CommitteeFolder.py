...
class CommitteeFolder(BaseFolder):
    """
    """
    ...
    archetype_name = 'CommitteeFolder'

    meta_type = 'CommitteeFolder'
    portal_type = 'CommitteeFolder'
    allowed_content_types = ['CommitteeWS']
    filter_content_types = 1
    global_allow = 0
    #content_icon = 'CommitteeFolder.gif'
    immediate_view = 'base_view'
    default_view = 'base_view'
    suppl_views = ()
    typeDescription = "CommitteeFolder"
    typeDescMsgId = 'description_edit_committeefolder'
