...
def setup_product():
    ...
    import bungenicms.repository
    zcml.load_config('configure.zcml', bungenicms.repository)
    ...
    ztc.installPackage('bungenicms.repository')
...
setup_product()
ptc.setupPloneSite(products=['bungenicms.repository'])
