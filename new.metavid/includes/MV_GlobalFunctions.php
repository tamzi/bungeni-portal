...
function enableMetavid() {
	...
	$smwgNamespacesWithSemanticLinks[MV_NS_MEMBER_OF_PARLIAMENT] = true;
	$smwgNamespacesWithSemanticLinks[MV_NS_MEMBER_OF_PARLIAMENT_TALK] = false;
	$smwgNamespacesWithSemanticLinks[MV_NS_BILLS] = true;
	$smwgNamespacesWithSemanticLinks[MV_NS_BILLS_TALK] = false;
	return true;
}
function mvSetupExtension() {
	...
	$wgAutoloadClasses['MV_SpecialListMPs']	= dirname( __FILE__ ) . '/specials/MV_SpecialListMPs.php';
	$wgSpecialPages['Members_of_Parliament']		   	= array( 'MV_SpecialListMPs' );
	
	$wgAutoloadClasses['MV_SpecialAddMP']	= dirname( __FILE__ ) . '/specials/MV_SpecialAddMP.php';
	$wgSpecialPages['Add_MP']		   	= array( 'MV_SpecialAddMP' );
	
	$wgAutoloadClasses['MV_SpecialAddSitting']	= dirname( __FILE__ ) . '/specials/MV_SpecialAddSitting.php';
	$wgSpecialPages['Add_Sitting']		   	= array( 'MV_SpecialAddSitting' );
...
function mvInitNamespaces() {
	...
	define( 'MV_NS_SITTING', 			$mvNamespaceIndex + 6 );
	define( 'MV_NS_SITTING_TALK', 		$mvNamespaceIndex + 7 );
	define( 'MV_NS_MEMBER_OF_PARLIAMENT', 			$mvNamespaceIndex + 8 );
	define( 'MV_NS_MEMBER_OF_PARLIAMENT_TALK', 		$mvNamespaceIndex + 9 );
	define( 'MV_NS_BILLS', 			$mvNamespaceIndex + 10 );
	define( 'MV_NS_BILLS_TALK', 		$mvNamespaceIndex + 11 );
	...
	$mvLastNamespaceIndex =  $mvNamespaceIndex + 11;
}
